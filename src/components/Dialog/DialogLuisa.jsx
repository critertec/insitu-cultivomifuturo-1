...
const DialogLuisa = () => {
  ...
  const textBody =
    etapa === "question"
      ...
      : etapa === "tutorial" && questionActive === 3
      ? DataJSON[etapa][questionActive][subQuestion]["options"][option][
          "retroalimentacion"
        ].body || false
      : DataJSON[etapa][questionActive][subQuestion]["intro-luisa"].body;

  const textBodyFeedbackQuestion =
    subQuestion === "b" &&
  ...
  console.log("============================================");
  console.log("textBodyFeedbackQuestion : ", textBodyFeedbackQuestion);
  console.log("============================================");
  const newTextBodyFeedBack = textBodyFeedbackQuestion || textBody;
